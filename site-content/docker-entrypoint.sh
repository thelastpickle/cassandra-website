...
generate_cassandra_versioned_docs() {
  ...
  do
    ...
    # git tags we need to make into branches (so commit_changes_to_branch works)
    if ! git symbolic-ref -q HEAD > /dev/null; then
      log_message "INFO" "Creating branch '${version}' from tag '${version}' to commit generated docs"
